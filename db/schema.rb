...
ActiveRecord::Schema.define(version: 2018_11_14_123526) do
  ...
  create_table "dhis", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
  ...
  create_table "global_property", primary_key: "property", id: :string, default: "", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "malaria_occurences_by_age_and_period", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.integer "person_id"
    t.float "age"
    t.string "period"
  end
  ...
  create_table "patient_defaulted_dates", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    ...
    t.date "date_created", default: "2014-10-12"
  end
  ...
  create_table "temp_cohort_report", primary_key: "patient_id", id: :integer, default: nil, options: "ENGINE=MEMORY DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.datetime "art_start_date", null: false
    t.datetime "art_earliest_start_date", null: false
    t.date "birthdate", null: false
    t.boolean "birthdate_estimated"
    t.integer "age_when_starting", null: false
    t.string "latest_outcome"
  end
  ...
  create_table "temperature_records", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "patient_identifier", limit: 35
  ...
  create_table "user_activations", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.datetime "created_at"
    t.datetime "updated_at"
  end
