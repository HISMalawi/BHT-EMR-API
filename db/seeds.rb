...
Drug.where(concept_id: 438, name: 'S (Streptomycin)', combination: 1, dosage_form: 4020, route: 3327, dose_strength: 1, units: 'mg', creator: 1, uuid: SecureRandom.uuid).first_or_create
...
NtpRegimen.where(drug: Drug.find_by(name: 'S (Streptomycin 0.50mgs)'), am_dose: 1, min_weight: 0, max_weight: 37, creator: 1).first_or_create
NtpRegimen.where(drug: Drug.find_by(name: 'S (Streptomycin 0.75mgs)'), am_dose: 1, min_weight: 38, max_weight: 54, creator: 1).first_or_create
NtpRegimen.where(drug: Drug.find_by(name: 'S (Streptomycin 1.00mgs)'), am_dose: 1, min_weight: 55, max_weight: 1000, creator: 1).first_or_create
