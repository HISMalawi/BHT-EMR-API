class CreateAllergyReactions < ActiveRecord::Migration[5.2]
  def change
    create_table :allergy_reactions, id: false do |t|
    ...
    add_foreign_key :allergy_reactions, :allergy, column: :allergy_id, primary_key: :allergy_id
    add_foreign_key :allergy_reactions, :concept, column: :reaction_concept_id, primary_key: :concept_id
  end
end
