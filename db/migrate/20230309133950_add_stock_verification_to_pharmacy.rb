...
class AddStockVerificationToPharmacy < ActiveRecord::Migration[5.2]
  def up
    ...
    return if foreign_key_exists?(:pharmacy_obs, :pharmacy_stock_verifications)

    add_reference :pharmacy_obs, :stock_verification, foreign_key: { to_table: :pharmacy_stock_verifications },
