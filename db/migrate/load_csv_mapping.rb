...
def load_csv_mapping
  ...
  CSV.foreach(CSV_FILE_PATH, headers: true) do |row|
    ...
    mappings << { facility_code: facility_code, location_id: location_id, location_name: location_name, location_district: location_district, facility_name: facility_name }
  end
