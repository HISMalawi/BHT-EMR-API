...
--
-- Host: 127.0.0.1    Database: solid_queue_prod
-- ------------------------------------------------------
...
--
-- Table structure for table `solid_queue_blocked_executions`
--
...
--
-- Table structure for table `solid_queue_claimed_executions`
--
...
--
-- Table structure for table `solid_queue_failed_executions`
--
...
--
-- Table structure for table `solid_queue_jobs`
--
...
--
-- Table structure for table `solid_queue_pauses`
--
...
--
-- Table structure for table `solid_queue_processes`
--
...
--
-- Table structure for table `solid_queue_ready_executions`
--
...
--
-- Table structure for table `solid_queue_recurring_executions`
--
...
--
-- Table structure for table `solid_queue_recurring_tasks`
--
...
--
-- Table structure for table `solid_queue_scheduled_executions`
--
...
--
-- Table structure for table `solid_queue_semaphores`
--
...
-- Dump completed on 2025-07-03 15:14:03
