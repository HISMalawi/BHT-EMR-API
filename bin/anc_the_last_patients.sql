...
SELECT p.ART_patient_id, p.ART_identifier, p.new_identifier_type,  p.preferred,  p.location_id,  c.ART_creator,  p.date_created,  p.void_reason, (SELECT uuid()) 
...
SELECT (SELECT @max_order_id + o.order_id) AS ART_order_id,
    ...
    o.discontinued_by, o.discontinued_reason, c.ART_user_id, o.date_created, o.voided,
