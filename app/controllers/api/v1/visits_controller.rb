...
module Api
    module V1
      ...
      class VisitsController < ApplicationController
        ...
        def daily_visits
        # Call the service method to get the daily visits
          daily_visits = VisitService.daily_visits      

        # Respond with the retrieved patient IDs
          render json: daily_visits, status: :ok 
        ...
        def generate_visit_number
         ...
         # render json: { next_visit_number: visit_number }, status: :ok    
          ...
          taken_visit_ids = Observation.joins(encounter:).where(
