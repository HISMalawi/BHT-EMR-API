  ...
  module Reports
    module Cohort
      ...
      module Tpt
        ...
        def newly_initiated_on_3hp(start_date, end_date)
          ...
          ActiveRecord::Base.connection.select_all <<~SQL
            ...
            INNER JOIN drug_order AS rfp_drug_orders
              ...
              AND rfp_drug_orders.drug_inventory_id IN (SELECT DISTINCT drug_id FROM drug INNER JOIN concept_name USING (concept_id) WHERE concept_name.name = 'Rifapentine')
        ...
        def newly_initiated_on_ipt(start_date, end_date)
        end
      end
    end
  end
