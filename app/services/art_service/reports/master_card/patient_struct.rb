module ARTService::Reports::MasterCard
  class PatientStruct < MastercardStruct
    ...
    def load_art_initiation
      {
        ...
        art_related_diseases: patient_history.who_clinical_conditions,
        who_stage: patient_who_stage,
        tb_status_at_art_initiation: calc_tb_status_at_art_initiation,
        kp: patient_history.hiv_staging_observation_present?("KP") ? "Y" : "N",
    ...
    def patient_who_stage
      Patient.find_by_sql("SELECT patient_who_stage(#{patient_id}) as who_stage").first.who_stage rescue nil
    end
