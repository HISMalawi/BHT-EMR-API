...
module AncService
  class PatientLabLabel
    ...
    def print
      ...
      @hepatitis_b = syphil['HEPATITIS B TEST RESULT']&.humanize.to_s

      @hb = syphil['HB TEST RESULT']&.humanize.to_s

      @serum_glucose = syphil['BLOOD GLUCOSE'].to_s
