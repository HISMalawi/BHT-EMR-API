  ...
  module Reports
    ...
    class CohortBuilder
      ...
      def build(cohort_struct, start_date, _end_date)
        ...
        cohort_struct.pre_hiv_negative_final_visit = pre_hiv_negative_final_visit&.to_a || []
        cohort_struct.not_done_hiv_test_final_visit = not_done_hiv_test_final_visit&.to_a || []
