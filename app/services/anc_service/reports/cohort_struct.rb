  ...
  module Reports
    ...
    class CohortStruct
      FIELD_DESCRIPTIONS = {
        ...
        patients_given_td_less_than_two_doses: 'Cohort: Patients given less tha two td doses',
        patients_given_td_at_least_two_doses: 'Cohort: Patients given at least two td doses',
        patients_given_zero_sp_doses: 'Cohort: Patients given zero sp doses',
        patients_given_one_sp_dose: 'Cohort: Patients given one sp dose',
