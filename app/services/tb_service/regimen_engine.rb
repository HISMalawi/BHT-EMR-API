...
module TBService
  class RegimenEngine
    ...
    def find_regimens(patient, pellets: false)
      ...
      tb_meningitis_drug_concept = concept 'Streptomycin'
    ...
    def find_dosages(patient, date = Date.today)
      ...
      tb_extras_concepts = [concept('Rifampicin isoniazid and pyrazinamide'), concept('Ethambutol'), concept('Rifampicin and isoniazid'), concept('Rifampicin Isoniazid Pyrazinamide Ethambutol'), concept('Streptomycin')] # add TB concepts
