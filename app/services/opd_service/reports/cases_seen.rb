...
module OpdService
  module Reports
    class CasesSeen
      ...
      def cases_seen(start_date, end_date, site_id = Location.current.location_id)
        ...
        Encounter.where("
          encounter_datetime BETWEEN ? AND ? AND encounter_type = ?
          AND c.name IN(?)
        ...
        .joins("INNER JOIN obs ON obs.encounter_id = encounter.encounter_id
          ...
          LEFT JOIN person_name n ON n.person_id = encounter.patient_id AND n.voided = 0 AND n.site_id = #{site_id}
