  ...
  module Reports
    class LaPrescriptions
      ...
      def build_report(start_date, end_date)
        ...
        prescription_report['total_la_one_prescribed_drugs'] = begin
          Order.find_by_sql(
            <<~SQL
        ...
        prescription_report['total_la_one_dispensed_drugs'] = begin
          Order.find_by_sql(
            <<~SQL
        ...
        prescription_report['total_la_two_prescribed_drugs'] = begin
          Order.find_by_sql(
            <<~SQL
              SELECT SUM((ABS(DATEDIFF(o.auto_expire_date, o.start_date)) * do.equivalent_daily_dose)) AS total_prescribed_drugs
              FROM encounter e
        ...
        prescription_report['total_la_two_dispensed_drugs'] = begin
          Order.find_by_sql(
            <<~SQL
        ...
        prescription_report['total_la_three_prescribed_drugs'] = begin
          Order.find_by_sql(
            <<~SQL
              SELECT SUM((ABS(DATEDIFF(o.auto_expire_date, o.start_date)) * do.equivalent_daily_dose)) AS total_prescribed_drugs
              FROM encounter e
        ...
        prescription_report['total_la_three_dispensed_drugs'] = begin
          Order.find_by_sql(
            <<~SQL
              SELECT SUM(obs.value_numeric) AS total_dispensed_drugs
              FROM encounter e
        ...
        prescription_report['total_la_four_prescribed_drugs'] = begin
          Order.find_by_sql(
            <<~SQL
              SELECT SUM((ABS(DATEDIFF(o.auto_expire_date, o.start_date)) * do.equivalent_daily_dose)) AS total_prescribed_drugs
              FROM encounter e
        ...
        prescription_report['total_la_four_dispensed_drugs'] = begin
          Order.find_by_sql(
            <<~SQL
              SELECT SUM(obs.value_numeric) as total_dispensed_drugs
              FROM encounter e
