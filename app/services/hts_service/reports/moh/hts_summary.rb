    ...
    module Moh
      ...
      class HtsSummary
        ...
        def fetch_confirmatory_clients
          @data['confirmatory_positive_total_prev_pos_professional_test'] =
            filter_hash('hiv_group', concept('Positive Re-Test').concept_id)
          @data['confirmed_positive_male'] = @data['confirmatory_positive_total_prev_pos_professional_test'].select do |q|
            q['gender'] == 'M'
          end
          @data['confirmed_positive_female'] = @data['confirmatory_positive_total_prev_pos_professional_test'].select do |q|
            q['gender'] == 'F'
          end

          @data['confirmatory_inconclusive_total_prev_pos_professional_test'] =
            filter_hash('hiv_group', concept('Inconclusive Re-Test').concept_id)
          @data['confirmed_inconclusive_male'] = @data['confirmatory_inconclusive_total_prev_pos_professional_test'].select do |q|
            q['gender'] == 'M'
          end
          @data['confirmed_inconclusive_female'] = @data['confirmatory_inconclusive_total_prev_pos_professional_test'].select do |q|
            q['gender'] == 'F'
          end
