    ...
    module Moh
      ...
      class HtsInitialTestedForHepb
        ...
        def linked_clients
          ...
          @data['linking_with_hiv_confirmatory_register_linked'] = query.select do |r|
            r['value_coded'] = 'Linked'
          end
          @data['linking_with_hiv_confirmatory_register_not_applicable_not_linked'] = query.reject do |r|
