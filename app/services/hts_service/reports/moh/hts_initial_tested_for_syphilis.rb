    ...
    module Moh
      ...
      class HtsInitialTestedForSyphilis
        ...
        INDICATORS = [
          ...
          { name: 'syphilis_test_result', concept_id: ConceptName.find_by_name(SYPHILIS_TEST_RESULT).concept_id, value: 'value_coded', join: 'INNER' },
          {
        ...
        def fetch_ever_taken_drugs_before
          ...
          @data['time_since_last_taken_arvs_same_day'] = @query.select { |q| get_diff(q['encounter_datetime'], q['time_since_last_medication']).zero? }
        ...
        def linked_clients
          ...
          @data['linking_with_hiv_confirmatory_register_not_applicable_not_linked'] = query.reject { |r| r['value_coded'] == concept('Linked').concept_id }
        end
      end
    end
  end
