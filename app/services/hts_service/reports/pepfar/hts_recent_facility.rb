          ...
          pepfar_age_groups.each_with_object({}) do |age_group, report|
            ...
            report[age_group] = GENDER_TYPES.each_with_object({}) do |gender, gender_sub_report|
              gender_sub_report[gender] = {
                ...
                index: { pos: [], neg: []},
                emergency: { recent: [], long_term: [] },
                inpatient: { recent: [], long_term: []  },
                sns: { recent: [], long_term: []  },
                tb: { recent: [], long_term: []  },
                pmtct_anc1: {recent: [], long_term: [] },
                pmtct_post_anc1: { recent: [], long_term: []  },
                vmmc: { recent: [], long_term: []  },
                vct: { recent: [], long_term: []  },
                other_pitc: { recent: [], long_term: []  }                
