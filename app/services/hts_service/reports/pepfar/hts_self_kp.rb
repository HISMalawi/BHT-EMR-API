          ...
          pepfar_age_groups.each_with_object({}) do |age_group, report|
            ...
            report[age_group] = GENDER_TYPES.each_with_object({}) do |gender, gender_sub_report|
              gender_sub_report[gender] = {
                ...
                index: { directly_assisted: [], unassisted: [] },
                pwid: { directly_assisted: [], unassisted: [] },
                msm: { directly_assisted: [], unassisted: [] },
                tg: { directly_assisted: [], unassisted: [] },
                fsw: { directly_assisted: [], unassisted: [] },
                prison: { directly_assisted: [], unassisted: [] }               
