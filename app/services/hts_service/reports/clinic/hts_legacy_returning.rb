    ...
    module Clinic
      class HtsLegacyReturning # rubocop:disable Style/Documentation
        ...
        def result_given_to_client
          data = connection.select_all(ObsValueScope.call(model: query, name: 'result_given',
                                                          concept_id: HIV_GROUP)).to_hash
        ...
        def partner_present
          data = connection.select_all(ObsValueScope.call(model: query, name: 'partner_present',
                                                          concept_id: PARTENER_PRESENT, value: 'value_text')).to_hash
          report.merge!({
        ...
        def last_tested
          data = connection.select_all(ObsValueScope.call(model: query, name: 'last_tested',
                                                          concept_id: LAST_TESTED)).to_hash
          report.merge!({
